...
export function Filter() {
   ...
   const entry = (section: Section, label: string, icon: React.ReactNode, count: number) => (
      <CommandItem
         ...
         // Keep focus inside the popover while the pane swaps.
   ...
   return (
      ...
      >
         ...
         <PopoverContent
            className="p-0 w-64"
            align="start"
            // Remounting the Command pane drops focus; without this Radix closes
            // the popover before the submenu can paint.
