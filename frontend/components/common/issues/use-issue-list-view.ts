...
import { useViewStore, normalizeViewType, type ViewType } from '@/store/view-store';
...
/** Groupings each layout can offer. The table takes more. */
...
export function useIssueListView(): IssueListView {
   ...
   const mode = normalizeViewType(url.layout ?? viewType);
