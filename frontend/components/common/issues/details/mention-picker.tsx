 ...
 *
 * Five kinds of thing can be named in a comment and they are not
 ...
 *
 * Only agents become mention *tokens*, because only they mean
 * anything to the server. People, tasks and projects are inserted as plain
 * text, which is what they are.
 */

type CandidateKind = 'member' | 'agent' | 'all' | 'issue' | 'project';
...
export function useMentionPicker(
   ...
   // been typed. People and agents are few enough to hold in hand.
   useEffect(() => {
   ...
   const choose = useCallback(
      (candidate: Candidate) => {
         ...
         // Only agents carry a token the server acts on. Everything
