      ...
      >
         ...
         <Link href={href} className="flex min-w-0 flex-1 items-center gap-2.5">
            ...
            <div className="min-w-0 overflow-hidden">
               ...
               {agent.description ? (
                  <p className="mt-0.5 line-clamp-1 text-muted-foreground">{agent.description}</p>
               ) : null}
            </div>
         </Link>
         ...
         <Cell column="runtime" columns={columns}>
            {roster?.runtimeId ? (
               ...
               <Badge
                  variant="outline"
                  className="max-w-full overflow-hidden border-amber-500/50 px-2 py-0.5 font-normal text-amber-500"
               >
