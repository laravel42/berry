 ...
 *
 * The top two tiers take alert colours. Medium takes info — a distinct hue so
 * it does not collapse into Low, without rivalling Urgent or High. Low and
 * none descend by opacity on muted, because the icons already encode those
 * tiers through the height and opacity of their bars.
 *
 ...
 *
 * The alpha range on the muted steps is tighter than it looks like it should
 * be because the faintest step still has to clear 3:1 against both backgrounds.
 * A priority icon is the only thing stating the tier in a dense row, so it is
 * meaningful non-text content rather than decoration, and fading it further
 * would put the lowest tiers below the floor.
 *
