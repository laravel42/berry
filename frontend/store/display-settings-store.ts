 ...
 *
 * A board grouped by status and a list grouped by assignee are the same list
 * asking two different questions, and forcing one answer on both meant
 * switching layout silently re-grouped the other one.
 */
