 ...
 *
 * Sign-in no longer depends on the App — it is a separate GitHub OAuth App from
 * BERRY_AUTH_GITHUB_* — so the usual way to create the App is to sign in and do
 * it from Settings. This remains for an operator who wants the App in place
 * before anyone has signed in, and it is deliberately the narrowest path that
